...
public class WxMenuController {
     ...
     */
    @ApiOperation(value = "创建个性化菜单-网页端设置")
    @PostMapping("/create")
    ...
    @GetMapping("/create")
    public Result menuCreateSample(@PathVariable String appid) throws WxErrorException, MalformedURLException {
        WxMenu menu = new WxMenu();
        WxMenuButton doctorButton = new WxMenuButton();
        doctorButton.setType(MenuButtonType.VIEW);
        doctorButton.setName("预约挂号");
        doctorButton.setKey("V1003_HOSPITAL");
        doctorButton.setUrl("https://org.gzjykj.tech/pages/index/index");//生产
        //doctorButton.setUrl("https://test.gzjykj.tech/pages/index/index");//测试

        WxMenuButton applyButton = new WxMenuButton();
        applyButton.setType(MenuButtonType.VIEW);
        applyButton.setName("AI应用");
        applyButton.setKey("V1002_APPLY");
        applyButton.setUrl("https://www.gzjykj.tech/");

        WxMenuButton chatButton = new WxMenuButton();
        chatButton.setType(MenuButtonType.VIEW);
        chatButton.setName("AI聊天");
        chatButton.setKey("V1001_CHAT");
        chatButton.setUrl("https://www.gzjykj.tech/pages/Questions/index/");

//        WxMenuButton memberButton = new WxMenuButton();
//        memberButton.setType(MenuButtonType.VIEW);
//        memberButton.setName("会员");
//        memberButton.setKey("V1003_APPLY");
//        memberButton.setUrl("https://www.gzjykj.tech/pages/User/index");


//        WxMenuButton userButton = new WxMenuButton();
//        userButton.setType(MenuButtonType.VIEW);
//        userButton.setName("获取用户信息");
...
//            userButton.setUrl(url);
//        }
//        memberButton.getSubButtons().add(userButton);

        //menu.getButtons().add(chatButton);//加载菜单
        //menu.getButtons().add(memberButton);//会员
        menu.getButtons().add(doctorButton);//挂号
        menu.getButtons().add(applyButton);

        this.wxService.switchover(appid);
        return Result.OK(this.wxService.getMenuService().menuCreate(menu));
    }
     ...
     */
    @ApiOperation(value = "删除自定义菜单-通过菜单Id")
