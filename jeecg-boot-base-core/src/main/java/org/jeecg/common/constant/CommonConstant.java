...
//    int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    /** 医生排班号源总数 */
    String PREFIX_DOCTOR_WORK_NUM  = "doctor_work_num:";

    /** 医生排班号分时段源总数 */
    String PREFIX_DOCTOR_WORK_PERIOD_NUM  = "doctor_work_period_num:";

    /** 患者预约锁 */
    String PREFIX_PATIENT_APPOINT_LOCK  = "patient_appoint_lock:";

    /** 患者预约序号 */
    String PREFIX_PATIENT_APPOINT_NUM  = "patient_appoint_num:";

    /** 患者预约序号 */
    String PREFIX_PATIENT_APPOINT_List = "patient_appoint_List:";

    /** 用户排队锁 */
    String PREFIX_PATIENT_QUEUE_LOCK  = "patient_queue_lock:";

    /** 患者排队序号 */
    String PREFIX_PATIENT_QUEUE_NUM  = "patient_queue_num:";

    /** 患者预约排队队列 */
    String PREFIX_PATIENT_APPOINT_QUEUE_LIST= "patient_appoint_queue_list:";

    /** 患者现场排队队列 */
    String PREFIX_PATIENT_QUEUE_LIST= "patient_queue_list:";
