...
public class oConvertUtils {
	 ...
	 * @return
	 */
	public static<F,T> List<T> toList(List<F> fromList, Class<T> tClass){
		if(fromList == null || fromList.isEmpty()){
			return new ArrayList<T>();
		}
		List<T> tList = new ArrayList<>();
	...
	/**
	 * @Description:page需要转换对象， targetClazz：转换的类
	 * @Author: tarzan
	 * @Date: 2019/10/31 9:40
	 */
	public static <T, E> IPage<T> toModelPage(IPage<E> page, Class<T> targetClazz) {
		IPage<T> pageResult = new Page(page.getCurrent(), page.getSize(), page.getTotal());
		pageResult.setPages(page.getPages());
		List<T> records = entityListToModelList(page.getRecords(), targetClazz);
	 ...
	 * @Date: 2019/10/31 9:40
	 */
	public static <E> IPage<E> pageInfoToIPage(PageInfo<E> page) {
		IPage<E> pageResult = new Page(page.getPages(), page.getSize(), page.getTotal());
		pageResult.setRecords(page.getList());
		return pageResult;
	}
